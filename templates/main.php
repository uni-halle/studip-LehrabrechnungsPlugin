...
<table cellspacing="2" cellpadding="2" border="0" width="600" class="zebra">
<tr>
...
<div style="margin-top:10px;">
	<?= Studip\Button::create(_("Eingaben abspeichern"), 'save') ?>
	&nbsp;
	<?= Studip\LinkButton::create(_("Eingabe abbrechen"), PluginEngine::getUrl($plugin)) ?>
</div>
</form>
</div>
